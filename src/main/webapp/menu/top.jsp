...
<DIV class='container' style='width: 100%;'> 
  <!-- 화면 상단 메뉴 -->
  <DIV class='top_menu'>
    <DIV class='top_menu_label_'>
    <c:if test="${sessionScope.id == null }">
        <A class='menu_link' href="${root }/member/create.do" >회원 가입 |</A>
    </c:if>  
    <c:choose>
    ...
    <NAV class='top_menu_list'>
      ...
      <A class='menu_link'  href='${root}/attachfile/list.do'>전체 이미지</A>
  ...
  <DIV class="row" style='margin-top: 2px;'>
    <DIV class="col-md-2"> <!-- 메뉴 출력 컬럼 -->
      ...
      <c:import url="/product_categrp/list_index_left.do" />
